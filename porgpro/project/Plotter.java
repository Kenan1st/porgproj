...
public class Plotter{
	...
	public String plot(){
		...
		String s = switch(e){
				case Va v -> "Va -> "+v.name()+";";
				case Cnst c -> "Cnst -> "+c.cnst()+";";
				case P p -> ""+Math.PI+";";
				case E eu -> ""+Math.E+";";
				case BOp b -> "-> BOp ;"+ 
						  "BOp -> {" + this.allocation(b) + "};"+
							       new Plotter(b.e_1()).plot() + new Plotter(b.e_2()).plot();

				default -> throw new IllegalArgumentException("Plotter Fehler");
		};
		return s;
	}

	public String allocation(Expr a){
		
	return switch(a){
			case BOp b -> "" + b.e_1().getClass().getSimpleName() +" , "+ b.e_2().getClass().getSimpleName();
			default -> throw new IllegalArgumentException("allocation Fehler");
		};
